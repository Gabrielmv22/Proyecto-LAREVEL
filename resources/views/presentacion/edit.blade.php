            ...
            <div class="row g-3">
                ...
                <div class="col-md-12">
                    ...
                    <select name="estado" id="estado" class="form-control">
                        <option value="1" {{ $presentacione->caracteristica->estado == 1 ? 'selected' : '' }}>Activo</option>
                        <option value="0" {{ $presentacione->caracteristica->estado == 0 ? 'selected' : '' }}>Inactivo</option>
                    </select>
                </div>
